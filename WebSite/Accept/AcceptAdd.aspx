                        ...
                        <table border="0" cellpadding="1" cellspacing="1" bgcolor="#999999" style="margin-top:20px;">
                            ...
                            <td colspan="9" bgcolor="#FFFFFF">
                                <asp:Repeater ID="rptClass" runat="server" OnItemDataBound="rptClass_ItemDataBound">
                                    <ItemTemplate>
                                        <div class="ClassTitle"><span class="span_open"></span><%#Eval("ClassName") %> （共 <%#Eval("rcount") %> 台）</div>
                                        ...
                                        <asp:Repeater ID="rptTerminal" runat="server">
                                            <ItemTemplate>
                                                <a href='javascript:;'><input type="checkbox" name="checkTermi" value="<%#Eval("ID") %>" /> <%#Eval("Location") %></a>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        </div>
                                    </ItemTemplate>
