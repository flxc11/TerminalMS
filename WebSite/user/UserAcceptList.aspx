<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAcceptList.aspx.cs" Inherits="WebSite.user.UserAcceptList" %>
    ...
    $('#tb').datagrid({
        ...
        columns: [[
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    return "<a href='UserAcceptDetail.aspx?AcceptGuid=" + row.AcceptGuid +
