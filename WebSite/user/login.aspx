<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WebSite.user.login" %>
    	...
    	<div class="login">
    		<form action="?Action=Login" name="form1" onsubmit="return CheckForm()" method="post" class="form-horizontal">
			    ...
			    <div class="control-group" style="padding-left: 122px;">
			      	...
			      	<input type="button" value="注册新用户" onclick="window.location.href = 'reg.aspx'">
			      </div>
			  </fieldset>
		    </form>
    	</div>
