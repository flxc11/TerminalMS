...
<script>
    ...
    $('#tb').datagrid({
        ...
        columns: [[
            ...
            {
                title: '上屏时间', field: 'StartTime', width: getWidth(0.1), align: 'center',
                formatter: function (value, row, index) {
                    return Common.TimeFormatter(row.StartTime, row, index);
                }
            },
            {
                title: '下屏时间', field: 'EndTime', width: getWidth(0.1), align: 'center',
                formatter: function (value, row, index) {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    return "<a href='AcceptEdit.aspx?AcceptGuid=" + row.AcceptGuid + "'>编辑</a>";
                }
            }
        ]],
        pagination: true,
