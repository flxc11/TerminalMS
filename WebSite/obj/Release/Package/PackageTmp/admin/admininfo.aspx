<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admininfo.aspx.cs" Inherits="WebSite.admin.admininfo" %>
            ...
            <div style="padding:50px 0 0 100px;">
			    <div class="control-group">
			      ...
			      <div class="controls controls-inline">
                      <asp:TextBox ID="UserName" CssClass="textbox" runat="server" ReadOnly="true"></asp:TextBox>
			      </div>
			    </div>
			    <div class="control-group">
