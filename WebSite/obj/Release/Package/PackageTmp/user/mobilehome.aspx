<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mobilehome.aspx.cs" Inherits="WebSite.user.mobilehome" %>
...
<body>
    ...
    <div class="wrap-header" style="width:100%; height:50px; background-size:50%; min-width:inherit">
        <div class="header" style="height:50px; background-size:50%;">
            <div class="lg-info">
                <h2>您好!欢迎使用本系统</h2>
                <a href="#">
    ...
    <div class="main-r" style="width:100%;left: 0; min-width:inherit;">
        ...
        <div id="container" style="width: 100%; float: left; margin-top: 30px;"></div>
        <div>
            <div id="container1" style="width: 100%; float: left;"></div>
