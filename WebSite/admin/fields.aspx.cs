...
{
    public partial class fields : AdminPage
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            fie.UserId = Convert.ToInt32(LoginInfo.LoginID);
            fie.UserType = "admin";
        ...
        public string GetChecked(string currentField)
        {
            ...
            DataTable dt1 = DataFactory.GetInstance().ExecuteTable(
                "select * from wzrb_Fields where UserID=" + LoginInfo.LoginID +
                    " and UserType='admin'");
