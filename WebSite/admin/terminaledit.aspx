...
<head runat="server">
    ...
    <script src="http://api.map.baidu.com/api?v=2.0&ak=CD6ba8c1f1a1796342ff6eeaf4b1f576"></script>
    <style>
        #l-map 
        {
            width:80%;
            ...
            <div class="main-form">
                <div class="cnvp-tab-panle">
                    <div class="table-1">
                        ...
                        <input type="hidden" name="Coordinate" id="Coordinate" value="<%=_locationCoordinate %>" />
...
<script type="text/javascript">
    ...
    if (point) {
        map.centerAndZoom(new BMap.Point(<%=_locationCoordinate %>), 18);
        var marker2 = new BMap.Marker(new BMap.Point(<%=_locationCoordinate %>));
        map.addOverlay(marker2);
    } else {
        point = new BMap.Point(120.669819, 28.019119);
