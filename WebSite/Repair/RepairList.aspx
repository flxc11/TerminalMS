<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairList.aspx.cs" Inherits="WebSite.Repair.RepairList" %>
    ...
    $('#tb').datagrid({
        ...
        columns: [[
            ...
            { title: '回复内容', field: 'ReplyContent', width: getWidth(0.1), align: 'center' },
            {
                ...
                formatter: function (value, row, index) {
                    return "<a href='RepairEdit.aspx?Guid=" + row.Guid +
                    ...
                    if (cand) {
                        $.messager.confirm('删除窗口', '确定要删除吗?', function (r) {
                            if (r) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/Repair/RepairJson.aspx?Time=" + new Date().getTime(),
                                    data: {
                                        action: "Delete",
                                        Guid: idsstr
                                    },
