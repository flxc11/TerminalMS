<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairAdd.aspx.cs" Inherits="WebSite.Repair.RepairAdd" %>
                ...
                <div class="cnvp-tab-panle">
                    <div class="table-1">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-inline">
                                <asp:TextBox ID="RepairContent" runat="server" CssClass="app-input" Height="100px" TextMode="MultiLine" Width="600px"></asp:TextBox>
                            </div>
                        </div>
                        <div class="control-group">
...
<script>
    $(function () {
        ...
        $("#RepairTime").datebox("setValue", strDate);
    });
    function submitForm(action) {
        if ($("#ff").form("validate")) {
            if (/^s*$/.test($("input[name='TerminalID']").val()) || $("input[name='TerminalID']").val() == undefined) {
                alert("所在位置输入有误，请重新输入！");
                return false;
            } else {
                function doSubmit() {
                    $("#ff").attr("action", "RepairAdd.aspx?Action=Save");
                    $("#ff").submit();
                }
